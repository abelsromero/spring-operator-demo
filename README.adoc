...
* Native image image size vs Java
    native: 128 MB or less
    Java: 512 minimum, but only for startup though
...
* Idea:
    Make Spring Operator for Spring Apps that provides "nice defaults"
